  ...
  return (
    <div className="contact-section">
      ...
      <div className="contact-box">
        ...
        <h3>How can we help?</h3>
        <h2>Have a question or feedback? Fill out the form below, and we'll get back to you.</h2>
        <div className="hero-right" data-aos="fade-up"></div>
      ...
      <footer className="footer-container">
        <div className="footer-main">
          <div className="footer-left">
            ...
            <div className="social-icons">
              <h3>Follow Us</h3>
              <div className="social-links">
                <a href="https://www.linkedin.com/in/siya-pandey64" target="_blank" rel="noopener noreferrer">
        ...
        <div className="footer-bottom">
          <p>© Empower Her project based on menstruation awareness. All rights reserved.</p>
          <div className="footer-links">
            <a href="#">Terms & conditions</a>
            <a href="#">Privacy policy</a>
          </div>
